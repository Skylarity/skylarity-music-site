<?php
$CURRENT_DIR = __DIR__;
$PAGE_TITLE = "Skylarity";
?>
<?php require_once("php/lib/head-utils.php"); ?>
	<body class="battlestation-bg">
		<?php require_once("php/lib/header.php"); ?>
		<div class="container">
			<div class="row content-pad">
				<div class="col-md-6">
					<h2 class="typewriter-text">Who?</h2>
					<p>
						Skylarity is a producer from New Mexico. He started out making chiptune music in PXTone, and graduated
						to FL Studio when he realized his love for all kinds of bass music.
					</p>
				</div>
				<div class="col-md-6">
...
<?php require_once("php/lib/foot-utils.php"); ?>